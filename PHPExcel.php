...
class PHPExcel
{
	...
	public function ReplaceKyTu($kytu)
	{
		if($kytu != '')
		{
							
			$kytu = str_replace('&iacute;','í');
			$kytu = str_replace('&uacute;','ú');
			$kytu = str_replace('&agrave;','à');
			$kytu = str_replace('&acirc;','â');
			$kytu = str_replace('&ugrave;','ù');
			$kytu = str_replace('&ocirc;','ô');
			$kytu = str_replace('&eacute;','é');
			$kytu = str_replace('&aacute;','a');
			$kytu = str_replace('&egrave;','è');
			$kytu = str_replace('&yacute;','ý');
			$kytu = str_replace('&deg;C','độ C');
			$kytu = str_replace('&Oslash;','Ø');
			$kytu = str_replace('&atilde;','ã');
			$kytu = str_replace('&gt;','>');
			$kytu = str_replace('&amp;','&');
			$kytu = str_replace('&lt;','<');
			$kytu = str_replace('&quot;','"');
			$kytu = str_replace('&ograve;','ò');
			$kytu = str_replace('&ecirc;','ê');
			$kytu = str_replace('&igrave;','ì');
			$kytu = str_replace('&aacute;','á');
			$kytu = str_replace('&times;','');
			$kytu = str_replace('&prime;','');
			$kytu = str_replace('&nbsp;',' ');
			$kytu = str_replace('&Aacute;','Á');
			$kytu = str_replace('&Acirc;','Â');
			$kytu = str_replace('&Iacute;','Í');
